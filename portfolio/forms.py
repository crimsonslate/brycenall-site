...
from crimsonslate_portfolio.forms import MediaEditForm as BaseEditForm
from crimsonslate_portfolio.forms import MediaSearchForm as BaseSearchForm
from crimsonslate_portfolio.forms import MediaUploadForm as BaseUploadForm


class MediaEditForm(BaseEditForm):
...
class MediaUploadForm(BaseUploadForm):
    base_attrs: dict[str, Any] = {
        "class": "w-full block bg-white rounded-md p-4 mt-2 mb-4 dark:text-gray-50 dark:bg-gray-800"
    }
...
class MediaSearchForm(BaseSearchForm):
    ...
    # base_attrs: dict[str, Any] = {
    #     "class": "w-full block bg-white rounded-md p-4 mt-2 mb-4 dark:text-gray-50 dark:bg-gray-800"
    # }
